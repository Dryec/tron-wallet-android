...
public class OwnVotesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAccount = Utils.getAccount(getContext(), WalletManager.getSelectedWallet().getWalletName());
    ...
    private class AccountUpdatedBroadcastReceiver extends BroadcastReceiver {
        ...
        @Override
        public void onReceive(Context context, Intent intent) {
            mAccount = Utils.getAccount(context, WalletManager.getSelectedWallet().getWalletName());
        }
    }
